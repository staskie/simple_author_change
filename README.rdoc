...
This is a ver simple plugin, yet very useful.
...
It is very similar to the plugin from here: https://github.com/mcl-de/redmine_change_issue_author with three exceptions:

* it's simpler, does not require any external dependencies
* it does not overwrite Redmie templates (it's using hooks)
* it's ... wait for it... working with Redmie 2.6!

And because it's so simple, it should really work with any Redmine versions
